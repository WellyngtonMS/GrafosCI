...
function changecompt() {
    ...
    window.nodesSet = new vis.DataSet([
	    ...
	    {level: 1, id: 'GDSCO0021', label: 'CL1', title: 'GDSCO0021 CIRCUITOS LOGICOS I', y: -1200},
	    ...
	    {level: 2, id: 'GDSCO0025', label: 'Materiais micro e nano', title: 'GDSCO0025 MATERIAIS PARA MICRO E NANO TECNOLOGIA', y: -1200},
	    {level: 2, id: 'GDSCO0022', label: 'CL2', title: 'GDSCO0022 CIRCUITOS LOGICOS II', y: -1100},
	    {level: 2, id: 'GDSCO0023', label: 'Eletricidade I', title: 'GDSCO0023 ELETRICIDADE E CIRCUITOS PARA COMPUTACAO I', y: -1000},
	    ...
	    {level: 3, id: 'GDSCO0024', label: 'Eletricidade II', title: 'GDSCO0024 ELETRICIDADE E CIRCUITOS PARA COMPUTACAO II', y: -1200},
	    {level: 3, id: '1107206', label: 'Pesquisa aplicada', title: '1107206 PESQUISA APLICADA A COMPUTACAO', y: -1100},
	    {level: 3, id: '1103232', label: 'Cálculo III', title: '1103232 CALCULO DIFERENCIAL E INTEGRAL III', y: -1000},
	    {level: 3, id: '1101171', label: 'Física I', title: '1101171 FISICA APLICADA A COMPUTACAO I', y: -900},
	    {level: 3, id: '1108136', label: 'Probabilidades I', title: '1108136 CALCULO DAS PROBABILIDADES I', y: -800},
	    {level: 3, id: 'GDSCO0046', label: 'Física Experimental', title: 'GDSCO0046 FISICA EXPERIMENTAL PARA COMPUTACAO', y: -700},
	    ...
	    {level: 4, id: 'GDSCO0059', label: 'Mecânica EC', title: 'GDSCO0059	MECANICA PARA ENGENHARIA DA COMPUTACAO', y: -700},
	    ...
	    {level: 6, id: 'GDSCO0040', label: 'CECI', title: 'GDSCO0040 CONCEPCAO ESTRUTURADA DE CIRCUITOS INTEGRADOS', y: -1100},
	    ...
	    {level: 6, id: 'GDSCO0081', label: 'Sistemas Embarcados I', title: 'GDSCO0081 SISTEMAS EMBARCADOS I', y: -700},

	    {level: 7, id: '5101001', label: 'ADSO', title: '5101001 AVALIACAO E DESEMPENHO DE SISTEMAS OPERACIONAIS', y: -1200},
	    {level: 7, id: '5102007', label: 'Pesquisa Operacional', title: '5102007 PESQUISA OPERACIONAL', y: -1100},
	    {level: 7, id: 'GDSCO0032', label: 'Redes sem Fio', title: 'GDSCO0032 REDES SEM FIO', y: -1000},
	    {level: 7, id: 'GDSCO0051', label: 'Int. à Comp. Gráfica', title: 'GDSCO0051 INTRODUCAO A COMPUTACAO GRAFICA', y: -900},
	    {level: 7, id: 'GDSCO0055', label: 'PDI', title: 'GDSCO0055 INTRODUCAO AO PROCESSAMENTO DIGITAL DE IMAGENS', y: -800},
	    {level: 7, id: 'GDSCO0065', label: 'Sistemas e Controle', title: 'GDSCO0065 SISTEMAS E CONTROLE DE AUTOMACAO', y: -700},

	    {level: 8, id: '1107128', label: 'Eng. de Software', title: '1107128 ENGENHARIA DE SOFTWARE', y: -1200},
	    {level: 8, id: '1107191', label: 'IA', title: '1107191 INTRODUCAO A INTELIGENCIA ARTIFICIAL', y: -1100},
	    {level: 8, id: 'GDSCO0028', label: 'Robótica', title: 'GDSCO0028 ROBOTICA', y: -1000},
	    {level: 8, id: 'GDSCO0054', label: 'Teoria da Informação', title: 'GDSCO0054 INTRODUCAO A TEORIA DA INFORMACAO', y: -900},
    ...
    window.edgesSet = new vis.DataSet([
	    ...
	    {to: 'GDSCO0053', from: 'GDSCO0023'},

	    {to: '5101003', from: 'GDSCO0035'},
	    {to: 'GDSCO0040', from: 'GDSCO0035'},
	    {to: 'GDSCO0064', from: '1103180'},
	    {to: 'GDSCO0068', from: '1107148'},
	    {to: 'GDSCO0081', from: 'GDSCO0035'},
	    ...
	    {to: 'GDSCO0029', from: 'HORAS1'},
	    {to: 'GDSCO0031', from: 'HORAS2'},
