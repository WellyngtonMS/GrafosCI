...
function changecompt() {
    ...
    window.nodesSet = new vis.DataSet([
	    ...
	    {level: 2, id: '1103179', label: 'Algebra', title: '1103179 INTRODUÇÃO A ÁLGEBRA LINEAR', y: -700},
	    ...
	    {level: 4, id: '1103180', label: 'Séries Eq. Ordinarias', title: '1103180 SÉRIES E EQUAÇÕES DIFERENCIAIS ORDINÁRIAS', y: -1200},
